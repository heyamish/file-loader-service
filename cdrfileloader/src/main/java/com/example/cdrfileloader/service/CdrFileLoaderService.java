package com.example.cdrfileloader.service;
...
import com.example.cdrfileloader.repository.CallDetailRecordRepository;
import com.example.cdrfileloader.repository.CdrLogRepository;
...
public class CdrFileLoaderService {
    ...
    public void processFiles() {
        ...
        if (!folder.exists() || !folder.isDirectory()) {
            System.err.println("CDR folder does not exist: " + new File(folderPath).getAbsolutePath());
            return;
        }
